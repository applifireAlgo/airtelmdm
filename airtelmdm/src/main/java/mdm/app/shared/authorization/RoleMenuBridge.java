...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "rakesh.padamshali@algorhythm.co.in", versionNumber = "3", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.authorization.RoleMenuBridge other = (mdm.app.shared.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;

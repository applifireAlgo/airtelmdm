...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "UserRoleBridge", complexity = Complexity.LOW)
...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.authorization.UserRoleBridge other = (mdm.app.shared.authorization.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;

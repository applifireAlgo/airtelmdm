package mdm.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AddressType", complexity = Complexity.LOW)
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.location.AddressType other = (mdm.app.shared.location.AddressType) obj;
            if (addressTypeId == null) {
                return false;

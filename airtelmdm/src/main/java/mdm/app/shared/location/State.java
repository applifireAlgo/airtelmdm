...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "State", complexity = Complexity.LOW)
...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.location.State other = (mdm.app.shared.location.State) obj;
            if (stateId == null) {
                return false;

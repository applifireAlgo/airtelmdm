...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Address", complexity = Complexity.LOW)
...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.location.Address other = (mdm.app.shared.location.Address) obj;
            if (addressId == null) {
                return false;

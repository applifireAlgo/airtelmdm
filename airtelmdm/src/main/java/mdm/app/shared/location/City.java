...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "City", complexity = Complexity.LOW)
...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.location.City other = (mdm.app.shared.location.City) obj;
            if (cityId == null) {
                return false;

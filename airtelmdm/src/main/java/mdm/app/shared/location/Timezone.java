...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Timezone", complexity = Complexity.LOW)
...
public class Timezone implements Serializable, CommonEntityInterface, TimeZoneInterface, Comparator<Timezone> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.location.Timezone other = (mdm.app.shared.location.Timezone) obj;
            if (timeZoneId == null) {
                return false;

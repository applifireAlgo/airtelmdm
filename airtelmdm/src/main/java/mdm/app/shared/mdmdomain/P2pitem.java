...
@Table(name = "ast_P2pitem_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "rakesh.padamshali@algorhythm.co.in", versionNumber = "6", comments = "P2pitem", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "P2pitem.findByManufacturerid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.manufacturerid=:manufacturerid"), @javax.persistence.NamedQuery(name = "P2pitem.findByItemmainid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.itemmainid=:itemmainid"), @javax.persistence.NamedQuery(name = "P2pitem.findByItemsubtypeid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.itemsubtypeid=:itemsubtypeid"), @javax.persistence.NamedQuery(name = "P2pitem.findByUomid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.uomid=:uomid"), @javax.persistence.NamedQuery(name = "P2pitem.findByItemcategoryid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.itemcategoryid=:itemcategoryid"), @javax.persistence.NamedQuery(name = "P2pitem.findByItemtypeid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.itemtypeid=:itemtypeid"), @javax.persistence.NamedQuery(name = "P2pitem.findBySbpid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.sbpid=:sbpid"), @javax.persistence.NamedQuery(name = "P2pitem.findByTechnologyid", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.technologyid=:technologyid"), @javax.persistence.NamedQuery(name = "P2pitem.findById", query = "select e from P2pitem e where e.systemInfo.activeStatus=1 and e.itemid =:itemid") })
public class P2pitem implements Serializable, CommonEntityInterface, Comparator<P2pitem> {
    ...
    public void setTechnical(String _technical) {
        if (_technical != null) {
            this.technical = _technical;
        }
    }
    ...
    @Override
    public int compare(P2pitem object1, P2pitem object2) {
        return 0;
    }
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.mdmdomain.P2pitem other = (mdm.app.shared.mdmdomain.P2pitem) obj;
            if (itemid == null) {
                return false;

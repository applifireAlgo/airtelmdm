...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "PasswordAlgo", complexity = Complexity.LOW)
...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.authentication.PasswordAlgo other = (mdm.app.shared.authentication.PasswordAlgo) obj;
            if (algoId == null) {
                return false;

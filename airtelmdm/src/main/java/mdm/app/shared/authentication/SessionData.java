...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "SessionData", complexity = Complexity.LOW)
...
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.authentication.SessionData other = (mdm.app.shared.authentication.SessionData) obj;
            if (dataId == null) {
                return false;

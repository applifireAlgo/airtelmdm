...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Question", complexity = Complexity.LOW)
...
public class Question implements Serializable, CommonEntityInterface, Comparator<Question> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.authentication.Question other = (mdm.app.shared.authentication.Question) obj;
            if (questionId == null) {
                return false;

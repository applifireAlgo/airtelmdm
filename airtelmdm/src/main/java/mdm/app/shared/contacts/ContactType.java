...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "ContactType", complexity = Complexity.LOW)
...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.contacts.ContactType other = (mdm.app.shared.contacts.ContactType) obj;
            if (contactTypeId == null) {
                return false;

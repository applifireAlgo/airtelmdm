...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Title", complexity = Complexity.LOW)
...
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.contacts.Title other = (mdm.app.shared.contacts.Title) obj;
            if (titleId == null) {
                return false;

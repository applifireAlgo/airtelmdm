...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "CommunicationData", complexity = Complexity.LOW)
...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.contacts.CommunicationData other = (mdm.app.shared.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;

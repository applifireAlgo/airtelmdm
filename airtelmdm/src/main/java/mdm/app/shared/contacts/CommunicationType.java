...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "CommunicationType", complexity = Complexity.LOW)
...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            mdm.app.shared.contacts.CommunicationType other = (mdm.app.shared.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;

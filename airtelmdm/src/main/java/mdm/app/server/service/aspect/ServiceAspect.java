package mdm.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* mdm.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mdm.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mdm.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mdm.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* mdm.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mdm.app.server.service..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")

...
@RequestMapping("/Itemcategorytype")
public class ItemcategorytypeServiceImpl extends ItemcategorytypeService {
    ...
    @Autowired
    private ItemcategorytypeRepository<Itemcategorytype> itemcategorytyperepo;
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<mdm.app.shared.mdmdomain.Itemcategorytype> lstitemcategorytype = itemcategorytyperepo.findAll();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstitemcategorytype);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    }

    @RequestMapping(consumes = "application/json", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody Itemcategorytype entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            itemcategorytyperepo.save(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<Itemcategorytype> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            itemcategorytyperepo.save(entity);
    ...
    public HttpEntity<ResponseBean> delete(@PathVariable("cid") String entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            itemcategorytyperepo.delete(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody Itemcategorytype entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            itemcategorytyperepo.update(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<Itemcategorytype> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            itemcategorytyperepo.update(entity);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            mdm.app.shared.mdmdomain.Itemcategorytype lstitemcategorytype = itemcategorytyperepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstitemcategorytype);
        } catch (org.springframework.transaction.TransactionException e) {

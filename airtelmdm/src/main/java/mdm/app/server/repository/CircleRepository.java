...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Circle Master table Entity", complexity = Complexity.LOW)
public interface CircleRepository<T> extends SearchInterface {
    ...
    public T findById(String circleid) throws Exception, SpartanPersistenceException;
}

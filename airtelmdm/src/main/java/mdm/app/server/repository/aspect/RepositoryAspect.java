package mdm.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* mdm.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mdm.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mdm.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mdm.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mdm.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* mdm.app.server.repository..*(..))")

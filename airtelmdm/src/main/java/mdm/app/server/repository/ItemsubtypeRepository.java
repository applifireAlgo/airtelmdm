...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Itemsubtype Master table Entity", complexity = Complexity.LOW)
public interface ItemsubtypeRepository<T> extends SearchInterface {
    ...
    public T findById(String itemsubtypeid) throws Exception, SpartanPersistenceException;
}

...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for City Master table Entity", complexity = Complexity.LOW)
public class CityRepositoryImpl extends SearchInterfaceImpl implements CityRepository<City> {
    ...
    public List<City> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<mdm.app.shared.location.City> query = emanager.createQuery("select u from City u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<City> save(List<City> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                mdm.app.shared.location.City obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            mdm.app.shared.location.City s = emanager.find(mdm.app.shared.location.City.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<City> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<mdm.app.shared.location.City> listOfCity = query.getResultList();
            return listOfCity;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public City findById(String cityId) throws Exception, SpartanPersistenceException {
        try {
            ...
            mdm.app.shared.location.City listOfCity = (mdm.app.shared.location.City) query.getSingleResult();
            return listOfCity;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }

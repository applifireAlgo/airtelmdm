...
public interface P2pitemcircleRepository<T> extends SearchInterface {
    ...
    public T findById(String p2itemcircleid) throws Exception, SpartanPersistenceException;
}

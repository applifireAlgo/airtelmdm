...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for AddressType Master table Entity", complexity = Complexity.LOW)
public class AddressTypeRepositoryImpl extends SearchInterfaceImpl implements AddressTypeRepository<AddressType> {
    ...
    public List<AddressType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<mdm.app.shared.location.AddressType> query = emanager.createQuery("select u from AddressType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AddressType> save(List<AddressType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                mdm.app.shared.location.AddressType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            mdm.app.shared.location.AddressType s = emanager.find(mdm.app.shared.location.AddressType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AddressType findById(String addressTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            mdm.app.shared.location.AddressType listOfAddressType = (mdm.app.shared.location.AddressType) query.getSingleResult();

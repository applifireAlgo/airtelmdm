...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Technology Master table Entity", complexity = Complexity.LOW)
public interface TechnologyRepository<T> extends SearchInterface {
    ...
    public T findById(String technologyid) throws Exception, SpartanPersistenceException;
}

...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Sbp Master table Entity", complexity = Complexity.LOW)
public interface SbpRepository<T> extends SearchInterface {
    ...
    public T findById(String sbpid) throws Exception, SpartanPersistenceException;
}

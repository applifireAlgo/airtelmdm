...
public interface SpocrequestRepository<T> extends SearchInterface {
    ...
    public List<T> findByItmmainid(String itmmainid) throws Exception, SpartanPersistenceException;
    ...
    public T findById(String spocrequestid) throws Exception, SpartanPersistenceException;
}

...
@SourceCodeAuthorClass(createdBy = "rakesh.padamshali@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for P2prequeststatus Master table Entity", complexity = Complexity.LOW)
public interface P2prequeststatusRepository<T> extends SearchInterface {

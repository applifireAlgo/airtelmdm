Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.ManufacturerMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.ManufacturerMainController',
     init: function() {
          var form = this.view.down('#ManufacturerForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#ManufacturerForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#ManufacturerGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#ManufacturerForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ManufacturerForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#ManufacturerGrid').store;
          gridStore.removeAll();

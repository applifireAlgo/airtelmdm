Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.SbpMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.SbpMainController',
     init: function() {
          var form = this.view.down('#SbpForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#SbpForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#SbpGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#SbpForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#SbpForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#SbpGrid').store;
          gridStore.removeAll();

Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.CircleMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.CircleMainController',
     init: function() {
          var form = this.view.down('#CircleForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CircleForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#CircleGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#CircleForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CircleForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CircleGrid').store;
          gridStore.removeAll();

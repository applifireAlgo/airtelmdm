Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.ItemmaintypeMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.ItemmaintypeMainController',
     init: function() {
          var form = this.view.down('#ItemmaintypeForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#ItemmaintypeForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#ItemmaintypeGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#ItemmaintypeForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ItemmaintypeForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#ItemmaintypeGrid').store;
          gridStore.removeAll();

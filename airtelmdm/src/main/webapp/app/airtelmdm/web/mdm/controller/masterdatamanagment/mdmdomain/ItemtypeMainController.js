Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.ItemtypeMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.ItemtypeMainController',
     init: function() {
          var form = this.view.down('#ItemtypeForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#ItemtypeForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#ItemtypeGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#ItemtypeForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ItemtypeForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#ItemtypeGrid').store;
          gridStore.removeAll();

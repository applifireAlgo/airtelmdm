Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.ItemcategorytypeMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.ItemcategorytypeMainController',
     init: function() {
          var form = this.view.down('#ItemcategorytypeForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#ItemcategorytypeForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#ItemcategorytypeGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#ItemcategorytypeForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ItemcategorytypeForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#ItemcategorytypeGrid').store;
          gridStore.removeAll();

Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.SpocrequeststatusMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.SpocrequeststatusMainController',
     init: function() {
          var form = this.view.down('#SpocrequeststatusForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#SpocrequeststatusForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#SpocrequeststatusGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#SpocrequeststatusForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#SpocrequeststatusForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#SpocrequeststatusGrid').store;
          gridStore.removeAll();

Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.UomMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.UomMainController',
     init: function() {
          var form = this.view.down('#UomForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#UomForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#UomGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#UomForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#UomForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#UomGrid').store;
          gridStore.removeAll();

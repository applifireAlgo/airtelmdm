Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.ItemsubtypeMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.ItemsubtypeMainController',
     init: function() {
          var form = this.view.down('#ItemsubtypeForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#ItemsubtypeForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#ItemsubtypeGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#ItemsubtypeForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ItemsubtypeForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#ItemsubtypeGrid').store;
          gridStore.removeAll();

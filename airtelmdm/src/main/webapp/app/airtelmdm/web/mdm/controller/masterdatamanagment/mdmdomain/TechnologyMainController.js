Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.TechnologyMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.TechnologyMainController',
     init: function() {
          var form = this.view.down('#TechnologyForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TechnologyForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#TechnologyGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#TechnologyForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TechnologyForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#TechnologyGrid').store;
          gridStore.removeAll();

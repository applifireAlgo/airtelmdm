Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.P2prequeststatusMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.P2prequeststatusMainController',
     init: function() {
          var form = this.view.down('#P2prequeststatusForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#P2prequeststatusForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#P2prequeststatusGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#P2prequeststatusForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#P2prequeststatusForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#P2prequeststatusGrid').store;
          gridStore.removeAll();

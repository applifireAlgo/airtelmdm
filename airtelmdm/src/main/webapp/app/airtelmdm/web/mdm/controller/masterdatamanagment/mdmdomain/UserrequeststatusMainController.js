Ext.define('Airtelmdm.airtelmdm.web.mdm.controller.masterdatamanagment.mdmdomain.UserrequeststatusMainController', {
     extend: 'Airtelmdm.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.UserrequeststatusMainController',
     init: function() {
          var form = this.view.down('#UserrequeststatusForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#UserrequeststatusForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#UserrequeststatusGrid');
               if (method == 'PUT') {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var formPanel = this.getView().down('#UserrequeststatusForm');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#UserrequeststatusForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#UserrequeststatusGrid').store;
          gridStore.removeAll();

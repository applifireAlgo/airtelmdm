 ...
 */
Ext.define('Airtelmdm.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Airtelmdm.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Airtelmdm.view.fw.component.DateTimePicker(o);
    },

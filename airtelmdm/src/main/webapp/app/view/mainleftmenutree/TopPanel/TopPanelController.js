Ext.define('Airtelmdm.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	doVoiceSearch:function(btn){
		...
		if(searchTab.length==0){
			 component = Ext.create(
					"Airtelmdm.view.searchengine.search.SearchEngineMainPanel", {
						closable : true,
						title : "Search Engine",
						refId : "-1",
						isSearchCmp:true
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Airtelmdm.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					menuId:'cloudtab'
				});
	...
	{
		var component = Ext.create(
				"Airtelmdm.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile",
					menuId:'myprofiletab'
				});

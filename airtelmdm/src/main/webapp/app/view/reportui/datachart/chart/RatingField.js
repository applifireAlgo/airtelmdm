...
Ext.define('Airtelmdm.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Airtelmdm.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Airtelmdm.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);

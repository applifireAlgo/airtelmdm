 ...
 * 
 */
Ext.define('Airtelmdm.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Airtelmdm.view.logalarm.LogAlarmMainViewController',
			'Airtelmdm.view.logalarm.tree.LogAlarmTreePanel',
			'Airtelmdm.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',

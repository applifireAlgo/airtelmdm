 ...
 * 
 */
Ext.define('Airtelmdm.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Airtelmdm.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});

 ...
 * 
 */
Ext.define('Airtelmdm.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Airtelmdm.view.logalarm.mainscreen.AddLogAlarmController',
			'Airtelmdm.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Airtelmdm.view.logalarm.mainscreen.AppAlarmPanel',

 ...
 * 
 */
Ext.define("Airtelmdm.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Airtelmdm.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],

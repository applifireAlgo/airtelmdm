Ext.define('Airtelmdm.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Airtelmdm.view.usermanagement.admin.AddUserDetailsViewModel', 'Airtelmdm.model.AddUserDataModel' ],

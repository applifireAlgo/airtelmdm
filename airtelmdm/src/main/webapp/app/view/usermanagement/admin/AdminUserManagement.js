Ext.define('Airtelmdm.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Airtelmdm.view.usermanagement.admin.UserPasswordReset',
	            'Airtelmdm.view.usermanagement.admin.AddUserDetails',
	            'Airtelmdm.view.usermanagement.admin.ViewUser'],

Ext.define('Airtelmdm.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Airtelmdm.view.usermanagement.enduser.UserProfileController', 'Airtelmdm.view.usermanagement.admin.AddUserDetailsViewModel', 'Airtelmdm.model.AddUserDataModel' ],

Ext.define('Airtelmdm.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Airtelmdm.view.searchengine.search.NorthPanel', 'Airtelmdm.view.searchengine.search.SearchResult','Airtelmdm.view.searchengine.search.SearchEngineMainPanelController'],

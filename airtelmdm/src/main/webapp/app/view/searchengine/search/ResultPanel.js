Ext
		.define(
				'Airtelmdm.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Airtelmdm.view.searchengine.search.SearchEngineMainPanelController','Airtelmdm.view.searchengine.search.PanelHeaderField' ,'Airtelmdm.view.searchengine.search.ReportGridView','Airtelmdm.view.searchengine.search.ReportChartView','Airtelmdm.view.searchengine.search.documentView','Airtelmdm.view.searchengine.search.DouMeanView','Airtelmdm.view.googlemaps.map.MapPanel'],

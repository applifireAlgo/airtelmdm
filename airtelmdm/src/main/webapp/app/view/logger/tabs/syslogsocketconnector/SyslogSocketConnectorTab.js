 ...
 * 
 */
Ext.define('Airtelmdm.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Airtelmdm.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],

...
Ext
		.define(
				'Airtelmdm.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Airtelmdm.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],

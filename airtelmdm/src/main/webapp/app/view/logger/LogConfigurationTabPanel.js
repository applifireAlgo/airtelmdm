...
Ext
		.define(
				'Airtelmdm.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Airtelmdm.view.logger.tabs.details.DetailsTab',
							'Airtelmdm.view.logger.tabs.fileconnector.FileConnectorTab',
							'Airtelmdm.view.logger.tabs.dbconnector.DBConnectorTab',
							'Airtelmdm.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Airtelmdm.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Airtelmdm.view.logger.LogConfigurationTabPanelController',

 ...
 */
Ext.define('Airtelmdm.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Airtelmdm.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Airtelmdm.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Airtelmdm.view.login.SessionLogin').center();
